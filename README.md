...
[Fork it](https://github.com/thewidgetsmith/dotfiles/fork), remove what you don't
...
```sh
git clone https://github.com/thewidgetsmith/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
./install
```
